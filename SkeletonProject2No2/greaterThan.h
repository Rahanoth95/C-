...
// This file contains the class definition of the GreaterThan class, which is a subclass of SubExpression,
...
// by returning the  greater difference of the values of the two subexpressions.
