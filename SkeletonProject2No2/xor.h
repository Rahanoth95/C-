...
// This file contains the class definition of the xOR class, which is a subclass of SubExpression,
...
// by returning the Xor function of the two subexpressions.
class Xor : public SubExpression {
public:
    Xor(Expression *left, Expression *right) : SubExpression(left, right) {
    }
